...
const client_1 = require("../../src/services/client");
...
suite('M2E API Client Test Suite', () => {
    ...
    suiteSetup(async () => {
        ...
        // Start mock server
        mockServer = new mockServer_1.MockM2EServer(18183); // Use different port
        await mockServer.start();
        // Create API client
        apiClient = new client_1.M2EApiClient(outputChannel);
    ...
    suite('getFileTypeFromDocument', () => {
        test('should detect JavaScript files', async () => {
            ...
            const fileType = (0, client_1.getFileTypeFromDocument)(document);
    ...
    suite('Error Handling', () => {
        test('should handle server connection errors', async () => {
            ...
            const badClient = new client_1.M2EApiClient(outputChannel);
        ...
        test('should handle timeout errors', async () => {
            ...
            const client = new client_1.M2EApiClient(outputChannel, 1); // 1ms timeout
